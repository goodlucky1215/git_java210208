...
//보내는 사람은 자기 메일 들어가서 설정에서 pop3설정 허락으로 바꾼 다음에 해야함.
public class SendMail {
	public static void main(String[] args) {
		String smtpServer = "smtp.naver.com";
		final String sendId = "아이디@naver.com";
		final String sendPass = "비밀번호 넣기";
		String sendEmailAddress = "아이디@naver.com";
		int smtpPort=465;
		
		//받는 분
		String receiveEmailAddress="아이디@naver.com";
