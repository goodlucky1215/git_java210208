...
public class SalaryMgrHandler1 implements ActionListener{
	SalaryMgrView1 smView = null;
	SalaryMgrLogic1 logic = null;
	public SalaryMgrHandler1(SalaryMgrView1 smView) {
		this.smView = smView;
	}
	@Override
	public void actionPerformed(ActionEvent ae) {
		logic = new SalaryMgrLogic1(this);
