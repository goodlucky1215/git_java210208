...
public class BaseBallGameLogic {
	 ...
	 * @return ex) 정답이:"256" 내가 친 수:"652" --> 1스트라이크 2볼(2자리는 숫자도 같고 위치도 같을 때, 1볼은 숫자는 있지만 위치가 다른 경우를 의미)
	 * 전역변수 회자를 말하는 cnt(대상이긴하나 바뀌어야함)
	 * 지역변수 strike, ball(static은 고려대상이 아님)
	 *******************************************/
