...
public class BaseBallView {
	...
	public void initDisplay(){
		...
		bbAction = new BaseBallAction(this);
		jtf_input.addActionListener(bbAction);
		jbtns[0].addActionListener(bbAction);
		jbtns[1].addActionListener(bbAction);
		jbtns[2].addActionListener(bbAction);
		jbtns[3].addActionListener(bbAction);
