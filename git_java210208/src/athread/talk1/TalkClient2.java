...
public class TalkClient2 extends JFrame implements ActionListener{
	...
	Socket             socket 	= null;
	//직렬화 누릴 수 있다.
	ObjectOutputStream oos 	  	= null; //말하는거
	ObjectInputStream  ois    	= null; //듣는거
	//닉네임
	...
	JButton		jptn_send 	= new JButton("전송");
	///////////두번째 화면에 들어갈 전역변수 선언//////////////
	String cols[]   = {"대화명"};
	...
	public void init() {
		try {
			...
			socket = new Socket("172.30.1.11",3000);
	...
	public static void main(String[] args) {
		TalkClient2 tc = new TalkClient2();
		tc.initDisplay();
		tc.init(); //소켓 처리
